...
def main(argv: list[str] | None = None) -> int:
    ap = argparse.ArgumentParser(prog="ddm-categorized-expectations", description="Get categorized expectations metadata")
    ...
    resp = client.parametrics.categorized_expectations()
